...
<main>
  ...
  <div id="contents">
    ...
    ?>
    <div class="system_message success">
      <p>
        設定を変更しました。
      </p>
    </div>
      ...
      <div class="tab_wrap">
        ...
        <div class="panel_area">
          ...
          <div id="panel1" class="tab_panel">
            ...
            <dl>
              <dt>送信元メールアドレス</dt>
              <dd><input type="email" name="senderaddress" id="senderaddress" value="<?php echo $senderAddress; ?>"><br>
                <p id="notice_memo">
                  通知メールの送信元メールアドレスを設定します。無記入の場合、通知先メールアドレスと同じアドレスが送信元となります。通知メールが迷惑メールに振り分けられる場合などに、通知先メールアドレスとは異なるアドレスを設定してみてください。
                </p>
              </dd>
            </dl>
          ...
          <div id="panel3" class="tab_panel">
            <dl>
              ...
              <dd>
                ...
                <?php
                echo koibumiShowDatas::showNGwords();
                ?>
              </dd>
            </dl>
            <dl>
              <dt>投稿を受け付けないIP</dt>
              <dd>
              <label><input type="text" name="newDenyIP" id="newDenyIP" placeholder="新しい拒否IP"></label>
                <?php
                echo koibumiShowDatas::showDenyIP();
                ?>
                <p style="margin-top:15px;">
                  <code>123.45.67.89</code>の他に、<code>123.45.*.*</code>のようにワイルドカードを使用して広範囲のIPアドレスをブロックすることができます。
                </p>
              </dd>
            </dl>
          </div>
