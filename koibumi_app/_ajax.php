...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  try {
    ...
    switch ($_POST['mode']) {
      case 'check':
        // URLを丸めてから渡す
        $postPath = koibumiCheckSendData::checkURL($_POST['path']);
        $message = koibumiCheckSendData::entity($_POST['message']);
        $title = koibumiCheckSendData::entity($_POST['title']);
        $token = $_POST['token'];
